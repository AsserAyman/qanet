export const translations = {
  ...
  ar: {
    ...
    startingSurah: 'السورة الأولى',
    startingAyah: 'الآية الأولى',
    endingSurah: 'السورة الأخيرة',
    endingAyah: 'الآية الأخيرة',
    readingRange: 'نطاق القراءة',
    start: 'البداية',
    end: 'النهاية',
    ...
    verses: 'آيات',
    trackerOverview: 'نظرة عامة على المتتبع',
    currentStreak: 'السلسلة الحالية',
    totalNights: 'إجمالي الليالي',
    versesRecitedPerNight: 'الآيات المتلوة في الليلة',
    lastNights: 'آخر 7 ليالي',
    ...
    genderDesc: 'هذا يساعدنا على تخصيص تجربتك',
    male: 'ذكر',
    female: 'أنثى',
    next: 'التالي',
    skip: 'تخطي',
    ...
    readingVolumeDesc: 'هذا يساعدنا على تخصيص تجربتك',
    ...
    trackYourJourneyDesc: 'أضف وعدل واحذف سجلات صلاتك بسهولة',
    understandYourProgress: 'افهم تقدمك',
    understandYourProgressDesc: 'شاهد كيف تنعكس قراءتك في مظهر التطبيق',
    stayMotivated: 'ابق متحفزاً',
    stayMotivatedDesc: 'فعّل التذكيرات وتتبع اتجاهاتك على مر الزمن',
